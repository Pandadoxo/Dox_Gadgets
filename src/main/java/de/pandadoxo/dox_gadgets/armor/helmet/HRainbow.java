...
public class HRainbow extends Helmet {

    public static final String NAME = "§8• §aRainbow Helm §8•";
    public static final GuiItem showItem = new GuiItem(NAME, Material.LEATHER_HELMET).setLeatherArmorColor(Color.fromRGB(85, 255, 85));
    public final GuiItem realItem = new GuiItem(NAME, Material.LEATHER_HELMET, true).setUnbreakable(true);

    public HRainbow(EHelmet helmet) {
        super(helmet);
    ...
    void onTick() {
        ...
        for (Player all : Bukkit.getOnlinePlayers()) {
            ...
            if (gPlayer.getHelmet().equals(getHelmet())) {
                all.getInventory().setHelmet(realItem.getItem());
            }
        }
    }
}
