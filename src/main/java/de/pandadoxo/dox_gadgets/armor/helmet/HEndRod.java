...
public class HEndRod extends Helmet {

    public static final String NAME = "§8• §dEinhorn §8•";
    public static final GuiItem showItem = new GuiItem(NAME, Material.END_ROD);
    public final GuiItem realItem = new GuiItem(NAME, Material.END_ROD, true);

    public HEndRod(EHelmet helmet) {
        super(helmet);
    }
